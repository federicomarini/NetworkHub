...
#' @examples
#' # main usage: -------------------------------------------------------------
#' ppi_human_v11.5 <- get_networkdata_STRINGDB(
#'   species = "Homo sapiens",
#'   version = "11.5"
#' )
#' dim(ppi_human_v11.5)
...
#'
#' ppi_mouse_v11.5 <- get_networkdata_STRINGDB(
...
#'
#' @examples
#' ppi_accinfo_human_v11.5 <- get_accessoryinfo_STRINGDB(
#'   species = "Homo sapiens",
#'   version = "11.5"
#' )
...
#'
#' graph_data <- get_networkdata_STRINGDB(
#'   species = "Homo sapiens",
#'   version = "11.5"
#' )
#'
...
build_graph_STRINGDB <- function(graph_data,
  ...
  if (length(subset_nodes) > 0) {
    my_graph <- igraph::induced.subgraph(
      whole_graph,
